        # Multilevelerror: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/multilevelerror.git

        ## Objective

        MultiLevelError models measurement error propagation in multilevel clinical data, providing bias-corrected meta-analytic estimates.
        ...
        - Code: https://github.com/mahmood726-cyber/multilevelerror.git
